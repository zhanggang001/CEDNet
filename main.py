...
def get_args_parser():
    ...
    parser.add_argument('--loss_weight', default='avg', type=str)
...
def main(args):
    ...
    assert args.model == 'convnext' or assigner is None, "layer decay value assigner only supports for convnext"
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        train_stats = train_one_epoch(
            ...
            use_amp=args.use_amp, loss_weight=args.loss_weight,
        )
