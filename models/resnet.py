...
class ResLayer(nn.Sequential):
    ...
    def __init__(self,
                 ...
                 **kwargs):
        self.block = block
        self.expansion = 4  # hard coding for Bottleneck
...
class ResNet(BaseModule):
    ...
    def __init__(self,
        ...
        self._make_stem_layer(in_chans, stem_channels)
        ...
        self.head = nn.Linear(res_layer[-1].out_channels, num_classes)
        self.init_weights()
...
@register_model
def resnet50(pretrained=False, init_weight=None, conv_stem=None, **kwargs):
